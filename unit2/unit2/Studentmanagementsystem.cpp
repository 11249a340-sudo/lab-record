...
int maxT=s[0].totalMarks(); int index=0;
for(int i=1;i<n;i++)
if(s[i].totalMarks()>maxT){maxT=s[i].totalMarks(); index=i;}
return s[index];
}
int main(){
int m1[5]={90,85,80,95,88};
int m2[5]={75,70,80,72,68};
int m3[5]={95,92,90,94,93};
Student s[3]={Student("Ravi",101,m1),
Student("Sita",102,m2),
Student("Anu",103,m3)};
